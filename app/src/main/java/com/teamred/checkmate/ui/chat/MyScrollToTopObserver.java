...
public class MyScrollToTopObserver<T extends FirebaseRecyclerAdapter> extends RecyclerView.AdapterDataObserver {
    private RecyclerView recycler;
    private T adapter;
    private LinearLayoutManager manager;

    public MyScrollToTopObserver(RecyclerView recycler, T adapter, LinearLayoutManager manager) {
